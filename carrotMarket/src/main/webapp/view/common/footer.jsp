    ...
    <footer class="footer background-dark-gray">
        <nav class="footer-nav">
            <div class="footer-nav__img">
                <img src="/carrotMarket/assets/images/logo-basic.svg" alt="logo-basic" />
            </div>
        ...
        <div class="footer-info">
            ...
            <div class="footer-info__list">
                <div class="info-list">
                    <img src="/carrotMarket/assets/images/icon-facebook.svg" alt="icon-facebook" class="info-list__item" />
                    <img src="/carrotMarket/assets/images/icon-instagram.svg" alt="icon-instagram" class="info-list__item" />
                    <img src="/carrotMarket/assets/images/icon-blog.svg" alt="icon-blog" class="info-list__item" />
                    <div class="info-list__item--country">
                        <img src="/carrotMarket/assets/images/icon-global.png" alt="icon-global" />
                        <span>한국</span>
                    </div>
                </div>
            </div>
